...
const courts = [
  ...
  },
  {
    ...
    price: 600,
    image:
      "https://images.unsplash.com/photo-1518605368461-1d59b208eb63?q=80&w=1200&auto=format&fit=crop",
    features: [
      { icon: <Users className="w-4 h-4" />, label: "10 players max" },
  ...
  <section className="py-16 md:py-24 bg-gray-50">
    <div className="w-full px-5 sm:px-8 md:px-12 lg:px-16 xl:px-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          <p className="font-dm text-[13px] text-gray-400 mb-2">
            Space Explorer
          </p>
        ...
        {courts.map((court, i) => (
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-1">
              <h3 className="font-syne font-bold text-[18px] text-gray-900 mb-3">
                {court.name}
              </h3>
              ...
              <div className="flex flex-col gap-2 mb-6">
                {court.features.map((f) => (
                  <div
                    key={f.label}
                    className="flex items-center gap-2.5 text-gray-500 font-dm text-[13px]"
                  >
              ...
              <div className="mt-auto flex items-center justify-between pt-4 border-t border-gray-100">
                <div>
                  <span className="font-syne font-extrabold text-[24px] text-gray-900">
                    ${court.price}
                  </span>
                  <span className="font-dm text-[12px] text-gray-400 ml-1">
                    /hr
                  </span>
                </div>
